...
<!----------------------------------------------------------->
 ...
 <!-----user add---->
              <div class="row">
                  <div class="col-6  ">
                    <h5 class="mb-4">Manage the Users </h5>
                  </div>
                  <div class="col-6  ">
 ...
 <!-----list search---->
              <div class="row">
                <div class="col-12">
                  <form  action="searchusr" method="GET">
                    <div class="input-group">
                      <input type="search" name="queryusr"  class="form-control rounded" placeholder="Search By User,Email,Role..." aria-label="Search" aria-describedby="search-addon" />
                    ...
                    <div class="col-12">
                        <div class="table-responsive" >
                                <table class="table custom-table">
                                        ...
                                        <tbody>
                                            <!-----list users---->
                                                @foreach ($showuser as $itms)
                                            <tr>
                                                <td scope="col">{{$itms->id}}</td>
                                                <td scope="col">{{$itms->name}}</td>
                                                <td scope="col">{{$itms->email}}</td>
                                                <td scope="col">{{$itms->rd}}</td>
                                                <td scope="col">
                                                    @if(auth()->user()->id==$itms->id)
                                                    <button type="button" class="btn btn-outline-secondary" disabled>This You</button>
                                                    <a href="/viewpagesetting/{{auth()->user()->id}}" ><button type="button" class="btn btn-success" > Edit  </button></a>
                                                    <a href="#"><button type="button" class="btn btn-secondary" hidden>View</button></a>
                                                    @else
                                                    <a href="/deleteus/{{$itms->id}}"><button type="button" class="btn btn-danger"> &#xA0; Delete &#xA0;</button></a>
                                                    <a href="/viewpageedituser/{{$itms->id}}" ><button type="button" class="btn btn-success" >Edit</button></a>
                                                    <a href="#"><button type="button" class="btn btn-secondary" hidden>View</button></a>
                                                    @endif
                                                </td>
                                            </tr>
                ...
                <div class="modal fade" id="exampleModalCenter" tabindex="-1" aria-labelledby="exampleModalCenterTitle"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="adduserss" method="POST">
                                <div class="mt-5">
                                    @if($errors->any())
                                        <div class ="col-12">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select  id="" name='rd' class="form-select">

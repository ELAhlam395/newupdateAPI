          ...
          @endauth
           ...
           <!-- <span >
            ...
            <div class="modal-content">
                ...
                <form action="/returncancel/{{$showsrvs->id}}" method="POST">
                        <div class="modal-body">
                            @csrf
                            <div class="mb-3">

                                <h3>{{$showsrvs->names}}</h3>

                            <H4 style="color: rgb(32, 116, 53)"> you sure return this server ?</H4>
                            </div>
                        ...
                        <div class="modal-footer">
                           <a href="{{url('viewpageservers')}}"> <button type="button" class="btn btn-secondary">cancel</button></a>

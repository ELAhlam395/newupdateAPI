        ...
        <div class="wrapper d-flex align-items-stretch">
          ...
          <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <div class="container">
              ...
              <div class="row">
                  <div class="col-6  ">
                    <h5 class="mb-4">Manage a Provider of a Domain</h5>
                  </div>
              ...
              <div class="row">
                ...
                <div class="table-responsive" >
                  ...
                  <table class="table custom-table">
                    <thead>
                      <tr>
                        <th scope="col">Id PROVIDER DOMAIN</th>
                    ...
                    <tbody>
                        @foreach ($Provider_Domain as $item)
                          <tr>
                            <td>{{$item->id}}</td>   
                            <td>{{$item->Name}}</td>   
                            <td>{{$item->Link}}</td>   
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Please a provider of a Domain</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form  method="POST" action="{{ route('store_provider_domain')}}">

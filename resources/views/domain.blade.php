        ...
        <div class="wrapper d-flex align-items-stretch">
              ...
              <ul class="list-unstyled components mb-5">
                ...
                <li>
                  ...
                  <ul class="collapse list-unstyled" id="homeSubmenu">
                    ...
                    <li>
                        <a href="/list_prov_server">Provider</a>
      
                        
                    </li>
      
                    <li>
                        <a href="/list_acc_server">Account</a>
                    </li>
                  </ul>
                </li>
                ...
                <li>
                  ...
                  <ul class="collapse list-unstyled" id="pageSubmenu">
                    <li  class="active">
                      <a href="/list_domain">Domain</a>
                  </li>
                    <li>
                        <a href="/list_accounts_domains">Account</a>
                    </li>
                    <li>
                      <a href="/list_prov_domain">Provider</a>
                    </li>
                  </ul>
                </li>
          ...
          <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <div class="container">
              ...
              <div class="row">
                  <div class="col-6  ">
                    <h5 class="mb-4">Manage a Domain</h5>
                  </div>
              ...
              <div class="row">
                ...
                <div class="table-responsive" >
                  ...
                  <table class="table custom-table">
                    <thead>
                      <tr>
                        <th scope="col">ID DOMAIN</th>
                        <th scope="col">NAME</th>
                        <th scope="col">DATE CREATION</th>
                        <th scope="col">DUE DATE</th>
                        <th scope="col">STATUS</th>
                        <th scope="col">ID ACCOUNT DOMAIN</th>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Please Add a Domain</h5>
                    ...
                    <form>
                      <div class="modal-body">
                          ...
                          <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Date Creation</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="Date_Creation">
                          </div>

                          <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Due Date</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="Due_Date">
                          </div>
                          ...
                          <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Id Acc Domain</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="Id_Acc_Domain">
                          </div>

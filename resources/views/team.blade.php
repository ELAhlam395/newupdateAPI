          ...
          <div id="content" class="p-4 p-md-5 pt-5">
              ...
              <nav class="navbar navbar-light bg-light ">
                ...
                <div class="container">
                    ...
                    <div class="row" >
                        <div class="col-6  ">
                          <h5 class="mb-4">Manage the Teams </h5>
                        </div>
                        <div class="col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <form  action="searchtm" method="GET">
                                <div class="input-group">
                                    <input type="text" name="querytm"  class="form-control rounded" placeholder="Search by Name Team or Application ..." aria-label="Search" aria-describedby="search-addon" />
                                    ...
                                    <div class="table-responsive" >
                                        <form action="" method="">
                                            ...
                                            <table class="table custom-table">
                                                    ...
                                                    <tbody>
                                                      @foreach ($showteams as $stm )
                                                      <tr>
                                                          <td scope="col">{{$stm->id}}</td>
                                                          <td scope="col">{{$stm->Name}}</td>
          
                                                          <td scope="col">
                                                              <a href="/deleteteam/{{$stm->id}}"><button type="button" class="btn btn-danger">Delete</button></a>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalCenterTitle">Please Add an Team</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>



                                                <form  action="addtm" method="POST">
                                                        <div class="mt-5">
                                                            @if($errors->any())
                                                                <div class ="col-12">
                                                                    @foreach($errors->all() as $error)
                                                    ...
                                                    <div class="modal-body">
                                                        @csrf
                                                        <div class="mb-3">
                                                            <label for="exampleInputEmail1" class="form-label">Name team</label>

...
<html lang="en">
  <head>
    ...
    <title>API | MANAGER  ACCOUNTS</title>
                        ...
                        <div class="table-responsive">
                          <table class="table custom-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$apiacc->user}}</td>
                                    <td>{{$apiacc->api_hash}}</td>
                                    <td>{{$apiacc->api_key}}</td>
                                    <td>{{$apiacc->api_get}}</td>
                                    <td>
                                        <a href="/deleteapiacc/{{$apiacc->id}}"><button type="button" class="btn btn-success">Delete</button></a>

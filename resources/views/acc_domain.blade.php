        ...
        <div class="wrapper d-flex align-items-stretch">
          ...
          <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <div class="container">
              ...
              <div class="row">
                  <div class="col-6  ">
                    <h5 class="mb-4">Manage an Account of a Domain</h5>
                  </div>
              ...
              <div class="row">
                ...
                <div class="table-responsive" >
                  ...
                  <table class="table custom-table">
                    ...
                    <tbody>
                        @foreach ($acc_prov_domain as $item)
                          <tr>
                            <td>{{$item->id}}</td>   
                            <td>{{$item->User}}</td>   
                            <td>{{$item->Password}}</td>   
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Please Add an Account of a Domain</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form method="POST" action="{{ route('store_acc_domain')}}">
